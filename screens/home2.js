  ...
  const getIconsFilter = (characters, option) => {
    ...
    data.map( (data) => {
      if(characters.includes(data.name) || option){
        var icon =  
          data.vision === "Pyro" ? require("../db/vision/Pyro.png") :
          data.vision === "Hydro" ? require("../db/vision/Hydro.png") :
          data.vision === "Electro" ? require("../db/vision/Electro.png") :
          data.vision === "Cryo" ? require("../db/vision/Cryo.png") :
          data.vision === "Anemo" ? require("../db/vision/Anemo.png") :
          data.vision === "Geo" ? require("../db/vision/Geo.png") :
          data.vision === "Dendro" ? require("../db/vision/Dendro.png") :
          require("../db/vision/Error.png");
        aux.push(
